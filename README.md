...
`lnks` is currently at version `2.0.0`, though I am only loosely tracking this. Please see [todo.md](todo.md) for a full list of changes for version 2, and a list of features for version 3.
